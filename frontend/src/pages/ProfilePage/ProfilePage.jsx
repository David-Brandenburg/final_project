...
const ProfilePage = ({ setProfilePicChange }) => {
  ...
  useEffect(() => {
    ...
    document.title = `${
      language === "en" ? "Your profile" : "Dein Profil"
    } | PixelPlaza`;
  }, [fetchUser, language]);
  ...
  const submitPassword = async (e) => {
    ...
    try {
      const resp = await fetch(url, {
        ...
        body: JSON.stringify(passwordToUpdate),
      });
      if (!resp.ok) {
        const data = await resp.json();
        toast.error(data.message);
                  ...
                  {(indexTab === "accountandsecurity" || indexTab === 'mygames') && (
                    <>
                      ...
                      <div className="profileInfo-content-row">
                        ...
                        <p style={{ color: user.vorname ? "unser" : "gray" }}>
                          {user.vorname ? user.vorname : "Nicht angegeben"}
                        </p>
                      </div>
                      <hr style={{ margin: "5px 0" }} />
                      <div className="profileInfo-content-row">
                        <p>{language === "en" ? "Lastname" : "Nachname"}:</p>
                        <p style={{ color: user.nachname ? "unser" : "gray" }}>
                          {user.nachname ? user.nachname : "Nicht angegeben"}
                        </p>
                      </div>
                    </>
                  )}
                    ...
                    <>
                      <div className="profileInfo-content-row">
                        ...
                        <p
                          style={{
                            color:
                              user.platformAccounts.Steam === ""
                                ? "gray"
                                : "unset",
                          }}>
                          {user && user.platformAccounts.Steam === ""
                            ? language === "en"
                              ? "Not linked"
                              : "Nicht verlinkt"
                            : user.platformAccounts.Steam}
                      ...
                      <div className="profileInfo-content-row">
                        ...
                        <p
                          style={{
                            color:
                              user.platformAccounts.EpicGames === ""
                                ? "gray"
                                : "unset",
                          }}>
                          {user && user.platformAccounts.EpicGames === ""
                            ? language === "en"
                              ? "Not linked"
                              : "Nicht verlinkt"
                            : user.platformAccounts.EpicGames}
                      ...
                      <div className="profileInfo-content-row">
                        ...
                        <p
                          style={{
                            color:
                              user.platformAccounts.Ubisoft === ""
                                ? "gray"
                                : "unset",
                          }}>
                          {user && user.platformAccounts.Ubisoft === ""
                            ? language === "en"
                              ? "Not linked"
                              : "Nicht verlinkt"
                            : user.platformAccounts.Ubisoft}
                      ...
                      <div className="profileInfo-content-row">
                        ...
                        <p
                          style={{
                            color:
                              user.platformAccounts.EAPlay === ""
                                ? "gray"
                                : "unset",
                          }}>
                          {user && user.platformAccounts.EAPlay === ""
                            ? language === "en"
                              ? "Not linked"
                              : "Nicht verlinkt"
                            : user.platformAccounts.EAPlay}
                      ...
                      <div className="profileInfo-content-row">
                        ...
                        <p
                          style={{
                            color:
                              user.platformAccounts.BattleNET === ""
                                ? "gray"
                                : "unset",
                          }}>
                          {user && user.platformAccounts.BattleNET === ""
                            ? language === "en"
                              ? "Not linked"
                              : "Nicht verlinkt"
                            : user.platformAccounts.BattleNET}
            ...
            {indexTab === "adminanddashboard" && (
              <>
                <div className="admin-index-tab-menu">
                  <p
                    className={`admin-index-tab-item ${
                      adminTab === "accounts" ? "active" : ""
                    }`}
                  ...
                  <p
                    ...
                    {language === "en" ? "Placeholder" : "Platzhalter"}
                  </p>
                  <hr
                    style={{
                      margin: "0",
          ...
          <div className="profile-content">
            <div className="profile-index-tab-menu">
              <p
                ...
                className={
                  indexTab === "accountandsecurity" ? "indextab-active" : ""
                }>
                {language === "en"
              ...
              <p
                ...
                className={
                  indexTab === "socialsandlinks" ? "indextab-active" : ""
                }>
                {language === "en"
                  ? "Socials and Links"
                  : "Soziales und Verlinkungen"}
              </p>
              {isAdmin && (
                <p
                  onClick={(e) => setIndexTab("adminanddashboard")}
                  className={
                    indexTab === "adminanddashboard" ? "indextab-active" : ""
                  }>
                  {language === "en"
                    ? "Admin and Dashboard"
                    : "Admin und Dashboard"}
            ...
            {indexTab === "accountandsecurity" ? (
              <>
                <form
                  ...
                  onSubmit={sumbitProfilePicUpload}>
                  ...
                  <button className="profile-btn" disabled={!hasFile}>
                    {language === "en" ? "Upload Image" : "Bild hochladen"}
                  </button>
                </form>
                ...
                <form className="profile-form-row" onSubmit={submitAccountInfo}>
                  ...
                  <div className="profile-inside-row">
                    <label htmlFor="">
                      {language === "en" ? "Change E-Mail" : "E-Mail ändern"}:
                    </label>
                    <input
                      className="profile-input"
                      type="email"
                  ...
                  <button
                    ...
                    disabled={
                      Object.keys(objectToUpdate).length < 1 ? true : false
                    }>
                    {language === "en"
                      ? "Change Account Info"
                ...
                <form className="profile-form-row" onSubmit={submitPassword}>
                  ...
                  <button
                    className="profile-btn"
                    disabled={
                      Object.keys(passwordToUpdate).length < 2 ? true : false
                    }>
