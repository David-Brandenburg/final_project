        ...
        <>
          ...
          <Swiper
            ...
            {gameData.trailer.length > 0 &&
              gameData.trailer.slice(0, 2).map((trailer, index) => (
              ...
              <div className="description-content">
                {Array.isArray(gameData.description) &&
                  gameData.description.map((item, index) => {
                    ...
                    if (
                      Object.keys(item)[0] === "paragraphDE" ||
                      Object.keys(item)[0] === "paragraphEN"
                    ) {
                      return (
                    ...
                    if (
                      Object.keys(item)[0] === "bannerDE" ||
                      Object.keys(item)[0] === "bannerEN"
                    ) {
                      return (
                        <img
                          key={"banner" + index}
